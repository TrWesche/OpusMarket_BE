...
class AuthHandling {
    ...
    static generateCookies(queryRes, queryData) {
        ...
        queryRes.cookie("_sid", split_token[2], {httpOnly: true, maxAge: 86400000, secure: true, sameSite: "None", domain: "https://opusmarket-backend.herokuapp.com/"});

        // Javascript Enabled Cookie - Full JWT
        // queryRes.cookie("sid", token, {signed: true, maxAge: 86400000});
        queryRes.cookie("sid", token, {httpOnly: false, maxAge: 86400000, secure: true, sameSite: "None", domain: "https://opusmarket-backend.herokuapp.com/"});
    }
